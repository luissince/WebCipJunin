<footer class="main-footer">
    ...
    <strong>Copyright © <?php echo date('Y'); ?> <a class="text-primary" href="http://www.cip-junin.org.pe/" target="_blank">Colegio de Ingenieros del Perú - CD Junín.</a> </strong> Todos los derechos reservados.
</footer>
<script>
