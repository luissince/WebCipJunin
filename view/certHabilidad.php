                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" style="border-width: 1px;border-style: dashed;border-color: #E31E25;">
                                    <thead style="background-color: #FDB2B1;color: #B72928;">
                                        ...
                                        <th style="width:7%;">Fecha de Pago</th>
                                        <th style="width:7%;">Fecha Venci.</th>
            ...
            function loadTableIngresos() {
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        arrayCertHabilidad.splice(0, arrayCertHabilidad.length);
                        state = true;
                    },
                    success: function(result) {
                        if (result.estado == 1) {
                            arrayCertHabilidad = result.data;
                            if (arrayCertHabilidad.length == 0) {
                                tbTable.empty();
                                tbTable.append(
                                ...
                                tbTable.empty();
                                for (let ingresos of arrayCertHabilidad) {
