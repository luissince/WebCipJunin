...
<<<<<<< HEAD
                    ...
                    <h4 style="padding-left:1em;"><i class="fa fa-user"></i> Actualizar Datos del Ingeniero(a): <span
                            id="Load_date"></span> <span id="name_ing"></span></h4>

                    <div>

                        <ul class="nav nav-tabs">
                            <li role="presentation"><a href="#General">General</a></li>
                            <li role="presentation"><a href="#">Colegiatura</a></li>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input id="dni" type="text" name="Dni" class="form-control"
                                                placeholder="DNI" required="" minlength="8"
...
>>>>>>> 6c5d9ac983bb5bbd45185ab605b30ffbc733a2a3
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 0.5em;">
                                        <div class="col-md-12">
    ...
    $(document).ready(function() {
        ...
        $("#btnaceptar").click(function() {
            if (state) {
                ...
                } else if (!$('#Tramite').is(":checked") && $("#Codigo").val() == '' || !$('#Tramite')
                    .is(":checked") && $("#Codigo").val().length < 4) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.estado === 1) {
                    ...
                    $("#name_ing").text(persona.Nombres + " " + persona.Apellidos)
