...
class PdfIngreso
{
    ...
    public static function createPdf($rutaImage, $nombre, $direccion, $telefono, $email, $web, $ruc, $ingreso, $detalleIngreso, $cuotas, $totales, $textoCodBar)
    {
